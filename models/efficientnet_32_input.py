...
def get_efficientnet_32_input(model_name, model_family, pretrained, num_classes, transfer_learning):
    if model_family != 'efficientnet_32_input':
        raise ValueError(f"Unsupported model family: {model_family}")
    
    efficientnet_dict = {
        'efficientnet_b0': efficientnet_b0,
        # 'efficientnet_b1': efficientnet_b1,
        # Add more variants (B2-B7) as needed
    }
    model_fn = efficientnet_dict.get(model_name)
    if not model_fn:
...
def test():
    ...
    model = get_efficientnet_32_input('efficientnet_b0', 'efficientnet_32_input', 
